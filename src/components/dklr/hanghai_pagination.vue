<template>
  <div>
    ...
    <div v-if="total > 0" class="vue-tiny-pagination pagination layout py-0 my-0" style="justify-content: flex-end; -webkit-justify-content: flex-end;">
      <div class="px-2 xs4 flex text-xs-right">
        <v-select
          class="pb-0 pt-1 my-0"
          style="width: 94px; float: right;"
      ...
      <ul class="tiny-pagination" :class="customClass">
        <li class="page-item" :class="classFirstPage">
          <button @click.prevent="lastPageLast" :class="classFirstPage" class="pagination__navigation">
            <i aria-hidden="true" style="font-size: 20px;" class="material-icons icon">first_page</i>
          </button>
        </li>
        <li class="page-item" :class="classFirstPage">
          <button @click.prevent="lastPage" :class="classFirstPage" class="pagination__navigation" style="border-left: 0;">
            <i aria-hidden="true" style="font-size: 20px;" class="material-icons icon">chevron_left</i>
          </button>
        </li>
        ...
        <li class="page-item" :class="classLastPage" style="margin-right: 0;">
          <button @click.prevent="nextPage" :class="classLastPage" class="pagination__navigation" style="border-left: 0;">
            <i aria-hidden="true" style="font-size: 20px;" class="material-icons icon">chevron_right</i>
          </button>
        </li>
        <li class="page-item" :class="classLastPage">
          <button @click.prevent="nextPageLast" :class="classLastPage" class="pagination__navigation">
            <i aria-hidden="true" style="font-size: 20px;" class="material-icons icon">last_page</i>
          </button>
        </li>
      </ul>
    </div>
